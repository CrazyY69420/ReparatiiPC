    ...
    <Layout>
      ...
      <section className="section-padding bg-background">
        <div className="container-custom">
          {/* Notice */}
          <div className="bg-accent/10 border border-accent/20 rounded-2xl p-6 mb-12 text-center">
                    ...
                    {category.items.map((item, i) => (
                      <li key={i} className="flex items-start justify-between gap-4">
                        ...
                        <span className={`font-semibold whitespace-nowrap ${
                          item.price === "Gratuit" ? "text-success" : "text-foreground"
                        }`}>
                          {item.price}
                        </span>
                      </li>
      ...
      <section className="section-padding bg-secondary/30">
        <div className="container-custom">
          <div className="bg-card rounded-3xl p-8 md:p-12 shadow-card border border-border text-center">
